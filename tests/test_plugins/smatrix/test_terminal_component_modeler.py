...
def test_antenna_helpers(monkeypatch, tmp_path):
    ...
    combined_data = TerminalComponentModeler._combine_directivity_data(
        normalized_data_array, normalized_data_const
    )
...
def test_antenna_parameters(monkeypatch, tmp_path):
    ...
    _ = run_component_modeler(monkeypatch, modeler)
    antenna_params = modeler.get_antenna_parameters_data()
...
def test_get_combined_antenna_parameters_data(monkeypatch, tmp_path):
    ...
    single_port_params = modeler.get_antenna_parameters_data()
